export const en = {
  ...
  checkBackendUrlDesc: 'Verify that the NEXT_PUBLIC_BACKEND_URL environment variable is correctly configured',
  ...
  serverNeoforge: 'Server with support for mods using Neoforge. Requires configuration of the specific version of Neoforge to be used.',
  ...
  serverModrinth: "Automatically installs modpacks from Modrinth. Can be configured using the modpack's URL, or slug.",
  serverGtnh: 'Deploys GT New Horizons with its dedicated container mode and recommended defaults for this modpack.',
  serverFtba: 'Automatically installs a Feed The Beast (FTB) modpack by its ID. The pack pins its own Minecraft and loader version.',
  ...
  serverPortProxyInfo: 'Port is managed by the proxy. All servers use internal port 25565 and connect via hostname.',
  ...
  playersOnlineCheckIntervalDesc: 'How often to check if players are online when backups are paused (e.g: 5m, 1m)',
  enableSaveAll: 'Enable Save All',
  enableSaveAllDesc: "Run 'save-all' command before backup. Disable if your server crashes during save-all (common with large worlds).",
  enableSaveAllWarning: 'Warning: With save-all disabled, ensure your server has autosave enabled or you may lose recent changes.',
  enableSync: 'Enable Filesystem Sync',
  enableSyncDesc: 'Flush filesystem buffers after save-all. Only disable in cluster environments with known issues.',
  // ===========================
  // RESOURCES TAB
  // ===========================
  ...
  gtnhRequirementsBody: 'Use 2-4 CPU cores, at least 6 GB of RAM, extra RAM per player, and 20 GB or more of storage. SSD is preferred.',
  gtnhJavaNote: 'GTNH supports Java 8 and 17+. Java 17+ is recommended, and java25 is the preferred option for GTNH 2.8.0 and later.',
  gtnhPackVersion: 'GTNH Pack Version',
  gtnhPackVersionDesc: 'Use a fixed version such as 2.8.1 for controlled upgrades, or latest/latest-dev if you want automatic updates.',
  gtnhDeleteBackups: 'Delete GTNH config backups on startup',
  gtnhDeleteBackupsDesc: 'Deletes the backup folders created by GTNH when config files are replaced during upgrades.',
  skipGtnhUpdateCheck: 'Skip GTNH update check',
  skipGtnhUpdateCheckDesc: 'Disable update checks after the first installation if you want to prevent automatic GTNH updates from running.',
  // FTB (Feed The Beast)
  ftbaRequirementsTitle: 'Feed The Beast modpack',
  ftbaRequirementsBody: 'Automatically installs an FTB modpack by its numeric ID. The pack pins its own Minecraft and loader version. Find the modpack ID on the pack page at feed-the-beast.com.',
  ftbModpackId: 'FTB Modpack ID',
  ftbModpackIdDesc: 'Numeric ID of the modpack on feed-the-beast.com (for example 119 for FTB Presents Direwolf20). Required.',
  ftbModpackVersionId: 'FTB Version ID (optional)',
  ftbModpackVersionIdDesc: 'Numeric ID of a specific pack version. Leave empty to always install the latest version.',
  ...
  paperCrossplayDesc: 'Paper server preconfigured with Geyser, Floodgate, ViaVersion and Bedrock UDP port 19132.',
  skyblock: 'SkyBlock',
  ...
  proxyToggleWarning: 'Before saving, make sure all servers are stopped. Changing the global proxy while servers are running can cause issues.',
  ...
  proxyHostnameDesc: 'Optional custom hostname for this server. Leave empty to auto-generate from server ID',
  useProxy: 'Use Proxy',
  ...
  publicIpDesc: 'Your server public IP or domain. Used for external player connections and notifications',
  lanIp: 'LAN IP',
  lanIpDesc: 'Your local network IP. For players on the same network',
  networkProxyNote: 'When proxy is enabled, the proxy hostname will be used instead of IP:port in notifications',
  javaServerDefaultsTitle: 'Java New Server Defaults',
  javaServerDefaultsDesc: 'Global defaults applied when creating new Java servers (vanilla and modded).',
  ...
  javaServerDefaultsApplyOnlyNewServers: 'These defaults are only applied during server creation. Existing servers are not modified.',
  // ===========================
  // BEDROCK EDITION
  // ===========================
